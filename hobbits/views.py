...
def getAuthdClient():
	...
	access_token = os.environ['FITBIT_ACCESS_TOKEN'] if os.environ.get('FITBIT_ACCESS_TOKEN') else settings.FITBIT_ACCESS_TOKEN
	refresh_token = os.environ['FITBIT_REFRESH_TOKEN'] if os.environ.get('FITBIT_REFRESH_TOKEN') else settings.FITBIT_REFRESH_TOKEN
